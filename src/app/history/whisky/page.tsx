          ...
          >
            ...
            <div className={pharagraphClass}>
              <ul>
                ...
                <li>
                  Debe ser destilado con un volumen de alcohol de mas de 95° de
                  volumen de alcohol
                </li>
            ...
            <div className={pharagraphClass}>
              <ul>
                ...
                <li>
                  Debe ser destilado con un volumen de alcohol de mas de 80° de
                  volumen de alcohol
                </li>
                <li>
            ...
            <h2 className={pharagraphClass}>
              ...
              mediante destilación por lotes en alambiques. Debe ser embotellado
              en Escocia.
            </h2>
            <h2 className={pharagraphClass}>
              <strong>Whisky escocés de grano único:</strong> se destila en una
              destilería individual, pero con la adición de otros cereales
              malteados o sin maltear.
            </h2>
            <h2 className={pharagraphClass}>
              <strong>Whisky escocés mezclado:</strong> una mezcla de uno o más
              whiskies escoceses de malta individuales, con uno o más whiskies
              escoceses de grano único.
            </h2>
            <h2 className={pharagraphClass}>
              <strong>Whisky escocés de malta mezclada:</strong> una mezcla de
              whiskies escoceses de malta única, que se han destilado en más de
              una destilería.
            </h2>
            <h2 className={pharagraphClass}>
              <strong>Whisky escocés de grano mezclado:</strong> una mezcla de
              whiskies escoceses de grano único, que se han destilado en más de
              una destilería.
            </h2>
            <h3 className={subtitleClass}>Tipos de Whiskey</h3>
            <h2 className={pharagraphClass}>
              <strong>Whiskey de centeno:</strong> el uso de centeno imparte un
              perfil picante y audaz en el whiskey y agrega densidad al cuerpo
              final. Debe hacerse con al menos un 51% de centeno, el resto es
              una mezcla de maíz y cebada; con características notas picantes y,
              aunque se puede hacer en cualquier lugar, generalmente se produce
              en Estados Unidos o Canadá..
            </h2>
            <h2 className={pharagraphClass}>
              <strong>Whiskey Bourbon:</strong> la forma más popular de whiskey
              estadounidense, el bourbon consiste en al menos un 51% de maíz y
              utiliza una mezcla de centeno, cebada y trigo en su puré o mash
              bill. Envejecido en barricas nuevas de roble carbonizado, durante
              al menos 2 años; Típicamente compuesto por notas dulces de
              vainilla, caramelo y madera.
            </h2>
            <h2 className={pharagraphClass}>
              <strong>Whiskey Tennessee:</strong> proveniente exclusivamente de
              Tennessee, debe incluir al menos un 51% de maíz y el resto se
              compensa con cebada, centeno o trigo. Similar al bourbon, pero se
              filtra a través de carbón de arce antes de envejecerse en barricas
              de roble. El proceso de filtración le da un sabor más suave y
              dulce, con notas de caramelo y vainilla.
            </h2>
          </div>
        ))}
